...
const COORDINATOR_POOL_ENV = "NEXT_PUBLIC_COORDINATOR_POOL_JSON";
const COORDINATOR_PRESET_ENV = "NEXT_PUBLIC_COORDINATOR_PRESET";
...
export function mutationsEnabled(env: Env = process.env): boolean {
  return env.NEXT_PUBLIC_ENABLE_MUTATIONS === "true";
}
